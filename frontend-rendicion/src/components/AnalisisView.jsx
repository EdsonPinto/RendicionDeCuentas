...
export const AnalisisView = ({
  ...
  <div className="analysis-layout">
    {filterSinSalidaOnly && (
      ...
      >
        <span
          style={{ fontWeight: "900", fontSize: "0.85rem", color: "#c2410c" }}
        >
          ⚠️ FILTRO ACTIVO: MOSTRANDO ÚNICAMENTE PROCESOS INACTIVOS SIN FECHA DE
          SALIDA REGISTRADA
        </span>
        <button
    ...
    {/* PANEL BUSCADOR */}
    <div
      className="strategic-filters-panel"
      style={{
        background: "#ffffff",
    ...
    >
      <h3
        className="filters-panel-title"
        style={{ color: "#000000", fontWeight: "900" }}
      >
        🔍 BUSCADOR DE PROCESOS EN TIEMPO REAL
      </h3>
      <div
        className="filters-grid-layout"
        ...
        <div className="filter-field-box">
          ...
          >
            ...
            <input
              ...
              onChange={(e) => {
                setSearchRadicadoFiltro(e.target.value);
                setLimitVigentes(50);
              }}
              style={{
                border: "none",
    ...
    >
      ...
      >
        ...
        >
          <span>
            {filterSinSalidaOnly
              ? "⚠️ PROCESOS SIN FECHA DE SALIDA"
              : "PROCESOS VIGENTES ACTIVOS"}{" "}
            ({filteredVigentes.length}) - Haz clic para ver detalle
          </span>
        </div>
        <div className="card-tabla-body">
          <table>
              ...
              {filteredVigentes.slice(0, limitVigentes).map((r, i) => (
                ...
                >
                  <td className="txt-center">
                    <span
                      className={`badge-semaforo ${r.sin_salida ? "badge-rojo" : r.dias < 30 ? "badge-verde" : r.dias <= 90 ? "badge-amarillo" : "badge-rojo"}`}
                    >
                      {r.sin_salida
                        ? "SIN SALIDA"
                        : r.dias < 30
                  ...
                  <td style={{ fontSize: "0.7rem", color: "#000000" }}>
                    {r.medio}
                  </td>
                  <td
                    className="col-ing"
